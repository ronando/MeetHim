package com.meethim.square.square;
...
import com.meethim.square.R;
import com.meethim.square.detail.DetailActivity;
...
public class MainRecyclerAdapter extends RecyclerView.Adapter<MainRecyclerAdapter.MainViewHolder> {
  ...
  public void onBindViewHolder(MainViewHolder holder, final int position) {
    holder.mTitle.setText((CharSequence) mList.get(position).get("words"));
